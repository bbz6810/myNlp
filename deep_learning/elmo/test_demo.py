...
from corpus import elmo_data_base_path, elmo_data_set_path, elmo_module_path
from deep_learning.elmo.lm_generator import LMDataGenerator
from deep_learning.elmo.model import ELMo
...
def running():
    # Set-up Generators
    train_generator = LMDataGenerator(os.path.join(elmo_data_set_path, parameters['train_dataset']),
                                      os.path.join(elmo_data_set_path, parameters['vocab']),
    ...
    val_generator = LMDataGenerator(os.path.join(elmo_data_set_path, parameters['valid_dataset']),
                                    os.path.join(elmo_data_set_path, parameters['vocab']),
                                    sentence_maxlen=parameters['sentence_maxlen'],
                                    token_maxlen=parameters['token_maxlen'],
                                    batch_size=parameters['batch_size'],
    ...
    # test_generator = LMDataGenerator(os.path.join(elmo_data_set_path, parameters['test_dataset']),
    #                                  os.path.join(elmo_data_set_path, parameters['vocab']),
    #                                  sentence_maxlen=parameters['sentence_maxlen'],
    #                                  token_maxlen=parameters['token_maxlen'],
    #                                  batch_size=parameters['batch_size'],
